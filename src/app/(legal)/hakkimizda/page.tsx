  ...
  return (
    <article className="bg-white rounded-2xl border border-orange-100 p-8">
      ...
      <div className="prose prose-sm max-w-none text-gray-600 leading-relaxed space-y-4">
        <p>Leziz Mama, evcil hayvanların sağlıklı, mutlu ve kaliteli bir yaşam sürmesi için ihtiyaç duydukları ürünleri güvenilir, hızlı ve ekonomik şekilde sunmak amacıyla kurulmuş bir e-ticaret platformudur.</p>
        <p>TNB Pet Mamaları ve Aksesuarları İthalat İhracat Sanayi ve Ticaret Limited Şirketi bünyesinde faaliyet gösteren Leziz Mama, kedi ve köpek başta olmak üzere tüm evcil dostlarımız için mama, bakım ve aksesuar ürünlerini titizlikle seçerek müşterilerine ulaştırmaktadır.</p>
        <h2 className="text-lg font-extrabold text-gray-800 mt-6 mb-3">Leziz Mama olarak önceliğimiz:</h2>
        ...
        <p>Leziz Mama'te her sipariş, güvenli ödeme altyapısı ile korunur, ürünleriniz özenle paketlenerek en kısa sürede adresinize ulaştırılır.</p>
        <div className="bg-orange-50 rounded-xl p-4 mt-6 border border-orange-100">
          <p className="text-sm font-semibold text-orange-700">"Leziz Mama, Türkiye Cumhuriyeti mevzuatına uygun olarak faaliyet gösteren, faturalı satış yapan bir e-ticaret sitesidir."</p>
        </div>
        <div className="mt-6 pt-6 border-t border-gray-100">
          <h2 className="text-lg font-extrabold text-gray-800 mb-3">Firma Bilgileri</h2>
          <div className="space-y-1 text-sm">
            <p><span className="font-semibold">Ünvan:</span> Leziz Mama – EV HAYVANLARI, BUNLARIN MAMA VE GIDALARI İLE EŞYALARININ PERAKENDE TİCARETİ</p>
