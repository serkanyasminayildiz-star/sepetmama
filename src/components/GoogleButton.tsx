  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 bg-white hover:bg-gray-50 disabled:opacity-50 text-gray-700 font-bold py-3 rounded-xl transition-colors"
      >
